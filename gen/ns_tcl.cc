...
\"\n\
checkout_executable TCLSH \"/home/kenchy/codes/CPP/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/kenchy/codes/CPP/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
Class SCSRNodeNew -superclass Node/MobileNode\n\
\n\
SCSRNodeNew instproc init args {\n\
$self instvar dsr_agent_ dmux_ entry_point_ address_\n\
\n\
set ns [Simulator instance]\n\
\n\
...
set dsr_agent_ [new Agent/SCDSRAgent]\n\
\n\
$dsr_agent_ addr $address_\n\
$dsr_agent_ node $self\n\
if [Simulator set mobile_ip_] {\n\
...
\n\
SCSRNodeNew instproc start-dsr {} {\n\
$self instvar dsr_agent_\n\
$dsr_agent_ startdsr\n\
}\n\
\n\
SCSRNodeNew instproc entry {} {\n\
$self instvar entry_point_\n\
return $entry_point_\n\
}\n\
\n\
SCSRNodeNew instproc add-interface args {\n\
eval $self next $args\n\
\n\
$self instvar dsr_agent_ ll_ mac_ ifq_\n\
\n\
...
\n\
SCSRNodeNew instproc reset args {\n\
$self instvar dsr_agent_\n\
eval $self next $args\n\
$dsr_agent_ reset\n\
}\n\
...
\n\
Class SCSRNode -superclass Node/MobileNode\n\
\n\
SCSRNode instproc init {args} {\n\
global ns ns_ opt tracefd RouterTrace\n\
$self instvar dsr_agent_ dmux_ entry_point_ address_\n\
set ns_ [Simulator instance]\n\
\n\
...
\n\
\n\
SCSRNode instproc add-interface {args} {\n\
global ns ns_ opt RouterTrace\n\
\n\
eval $self next $args\n\
\n\
...
\n\
\n\
proc scdsr-create-mobile-node { id args } {\n\
global ns_ chan prop topo tracefd opt node_\n\
set ns_ [Simulator instance] \n\
if [Simulator hier-addr?] {\n\
if [Simulator set mobile_ip_] {\n\
set node_($id) [new SCSRNode/MIPMH $args]\n\
} else {\n\
set node_($id) [new SCSRNode $args]\n\
}\n\
} else {\n\
set node_($id) [new SCSRNode]\n\
}\n\
set node $node_($id)\n\
$node random-motion 0		;# disable random motion\n\
$node topography $topo\n\
...
\n\
Agent/SCDSRAgent set sport_ 255\n\
Agent/SCDSRAgent set dport_ 255\n\
\n\
...
$inerrProc_ $outerrProc_ $FECProc_\n\
if {$routingAgent_ != \"DSR\" && $routingAgent_ != \"SCDSR\" } {\n\
$node attach $ragent [Node set rtagent_port_]\n\
}\n\
...
} elseif { $routingAgent_ == \"SCDSR\" } {\n\
set nodeclass [$self set-scdsr-nodetype]\n\
} else {\n\
...
\n\
Simulator instproc set-scdsr-nodetype {} {\n\
$self instvar wiredRouting_ \n\
set nodetype SCSRNodeNew\n\
if [Simulator set mobile_ip_] {\n\
set nodetype SCSRNodeNew/MIPMH\n\
} \n\
if { [info exists wiredRouting_] && $wiredRouting_ == \"ON\"} {\n\
set nodetype Node/MobileNode/BaseStationNode\n\
}\n\
