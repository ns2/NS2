...
extern Time SC_RR_timeout;		// (sec) route request timeout
extern Time sc_arp_timeout;	// (sec) arp request timeout
extern Time sc_retry_arp_period;	// secs time between arps
extern Time sc_rt_rq_period;	// secs length of one backoff period
extern Time sc_rt_rq_max_period;	// secs maximum time between rt reqs
extern Time sc_rt_rep_holdoff_period;
