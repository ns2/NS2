...
$node_(0) set Z_ 0
$node_(0) color "gold"
$ns_ at 0.0 "$node_(0) label \"Max Delay:7\""

$node_(1) set X_ 800
$node_(1) set Y_ 700
$node_(1) set Z_ 0
$node_(1) color "red"
$node_(1) addService 1 1 1
$ns_ at 0.0 "$node_(1) label \"(s1 1 1)\""

$node_(2) set X_ 620
$node_(2) set Y_ 590
$node_(2) set Z_ 0
$node_(2) color "blue"
$node_(2) addService 2 2 1
$ns_ at 0.0 "$node_(2) label \"(s2 2 1)\""

$node_(3) set X_ 340
$node_(3) set Y_ 300
$node_(3) set Z_ 0
$node_(3) color "purple"
$node_(3) addService 3 2 1
$ns_ at 0.0 "$node_(3) label \"(s3 2 1)\""
...
$node_(5) set Z_ 0
$node_(5) color "red"
$node_(5) addService 1 4 1
$ns_ at 0.0 "$node_(5) label \"(s1 4 1)\""
...
$node_(11) set Y_ 440
$node_(11) set Z_ 0
$node_(11) addService 3 1 1
$node_(11) color "purple"
$ns_ at 0.0 "$node_(11) label \"(s3 1 1)\""
...
$ns_ at 0.35 "$node_(11) setdest 1100 400 500.0"
#$ns_ at 0.70 "$node_(11) setdest 1100 450 500.0"
$ns_ at 1.45 "$node_(3) setdest 900 450 350.0"
#$ns_ at 2.2 "$node_(11) setdest 1100 560 450.0"
#$ns_ at 0.85 "$node_(11) setdest 800 310 450.0"
...
set v [expr "0.3 * $i"]
$ns_ at $v "$udp_(0) send 900 \"fs:1,2,3:f1,f2,f3:7\"";
}
