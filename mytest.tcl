...
$node_(1) set Y_ 300
$node_(1) set Z_ 0
$node_(1) addService 11
$node_(1) color "purple"
...
$ns_ at 0.4 "$node_(11) setdest 1050 430 500.0"
$ns_ at 0.95 "$node_(1) setdest 700 450 450.0"
$ns_ at 2.55 "$node_(1) setdest 850 450 450.0"
...
set v [expr "0.3 * $i"]
$ns_ at $v "$udp_(0) send 900 \"fs:4,8,4,8:f1,f2,f3:1.5\"";
}
